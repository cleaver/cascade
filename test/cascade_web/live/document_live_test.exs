defmodule CascadeWeb.DocumentLiveTest do
  use CascadeWeb.ConnCase

  import Phoenix.LiveViewTest
  import Cascade.ContentFixtures

  @create_attrs %{title: "some title", body: "some body", slug: "some slug", publish_at: "2024-01-07T19:49:00Z"}
  @update_attrs %{title: "some updated title", body: "some updated body", slug: "some updated slug", publish_at: "2024-01-08T19:49:00Z"}
