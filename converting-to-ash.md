# The Process of Converting to Ash

## Resources

The application was generated as a normal Phoenix LiveView application with Ecto.
The Ecto context, `content` and schemas were replaced by Ash resources.

The resources are in [lib/cascade/content](lib/cascade/content).
